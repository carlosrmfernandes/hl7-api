...
class Msh extends Migration
{
    ...
    public function up()
    {
        Schema::create('msh', function (Blueprint $table) {
            ...
            $table->string('encoding_characters_2')->nullable();
            ...
            $table->string('security_8')->nullable();
            $table->string('message_code_9_1')->nullable();
            $table->string('trigger_event_9_2')->nullable();
            $table->string('message_structure_9_3')->nullable();
            $table->string('message_control_id_10')->nullable();
            $table->string('processing_id_11_1')->nullable();
            $table->string('processing_mode_11_2')->nullable();
            $table->string('version_id_12_1')->nullable();
